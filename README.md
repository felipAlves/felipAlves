...
<p align="left">
  🔥 Estudando atualmente: <strong> C# e ASP.NET </strong>
</p>

<p align="left">
  Conhecimentos: 
  <ul>
    <li>Avançado: <strong>Javascript, Typescript, Styled Components, NextJs, PHP, React, NodeJs, AdonisJs, MySQL, HTML5, CSS3</strong></li>
